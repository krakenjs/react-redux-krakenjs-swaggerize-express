...
/**
 * Test for /store/order
 */
Test('/store/order', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 400
         */
        t.test('test placeOrder post operation', function (t) {
            Mockgen().requests({
                path: '/store/order',
                operation: 'post'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/store/order']['post']['responses']['200']['schema']);
