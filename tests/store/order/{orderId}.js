...
/**
 * Test for /store/order/{orderId}
 */
Test('/store/order/{orderId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getOrderById get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/store/order/{orderId}']['get']['responses']['200']['schema']);
         ...
         * responses: 400, 404
         */
        t.test('test deleteOrder delete operation', function (t) {
            Mockgen().requests({
                path: '/store/order/{orderId}',
                operation: 'delete'
            }, function (err, mock) {
