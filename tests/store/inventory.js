...
/**
 * Test for /store/inventory
 */
Test('/store/inventory', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getInventory get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/store/inventory']['get']['responses']['200']['schema']);
