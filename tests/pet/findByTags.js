...
/**
 * Test for /pet/findByTags
 */
Test('/pet/findByTags', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 400
         */
        t.test('test findPetsByTags get operation', function (t) {
            Mockgen().requests({
                path: '/pet/findByTags',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/pet/findByTags']['get']['responses']['200']['schema']);
